...
A real-time sentiment analysis tool for YouTube comments using FastAPI, React, and AWS Comprehend.
...
4. **Data Storage**: Store data locally (JSON/CSV) by default, or configure it to use AWS S3 for cloud-based storage.
...
- **Storage**: Local files (JSON/CSV), AWS S3 (optional)
